        ...
        <form onSubmit={handleSubmit}>
          <div className="modal-body" style={{ padding: "16px 20px" }}>
            <div className="settings-field">
              <label>
                <span>{locale === 'zh' ? '原文件名' : 'Original File Name'}</span>
            ...
            <div className="settings-field" style={{ marginTop: "12px" }}>
              <label>
                ...
                <span className="field-desc">
                  {locale === 'zh' ? '包含后缀名' : 'Include file extension'}
                </span>
              </label>
          ...
          <div className="modal-footer" style={{ padding: "12px 20px", display: "flex", justifyContent: "flex-end", gap: "10px" }}>
            ...
            <button type="submit" className="btn btn-primary" disabled={!fileName.trim() || fileName.trim() === fileNode.name}>
