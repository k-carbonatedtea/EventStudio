    ...
    <div className="settings-tab-pane">
      ...
      <div className="settings-field">
        <label>
          ...
          <span className="field-desc">
            {locale === 'zh'
              ? '包含 EventFlow, Actor, Pack 等资源的 romfs 文件夹'
              : 'Main romfs folder containing EventFlow, Actor, Pack resources'}
          </span>
        </label>
        <div className="path-input-group">
          ...
          <button
            ...
            onClick={() =>
              onBrowse(
                'gameDir',
                locale === 'zh' ? '选择 Switch RomFS 目录' : 'Select Switch RomFS Directory',
              )
            }
          >
      ...
      <div className="settings-field">
        <label>
          ...
          <span className="field-desc">
            {locale === 'zh'
              ? 'Switch 版本的 DLC romfs 文件夹（可选）'
              : 'Switch version DLC romfs directory (Optional)'}
          </span>
        </label>
        <div className="path-input-group">
          <input
          ...
          <button
            ...
            onClick={() =>
              onBrowse(
                'dlcDir',
                locale === 'zh'
                  ? '选择 Switch DLC RomFS 目录'
                  : 'Select Switch DLC RomFS Directory',
              )
            }
          >
            <Folder size={14} /> {t('common.browse')}
      ...
      <div className="settings-field">
        <label>
          ...
          <span className="field-desc">
            {locale === 'zh'
              ? 'Atmosphere LayeredFS 导出目录 (contents/01007EF00011E000/romfs)'
              : 'Atmosphere LayeredFS export directory (contents/.../romfs)'}
          </span>
        </label>
        <div className="path-input-group">
          <input
          ...
          <button
            ...
            onClick={() =>
              onBrowse(
                'exportDir',
                locale === 'zh' ? '选择 Switch 模组导出路径' : 'Select Switch Mod Export Path',
              )
            }
          >
            <Folder size={14} /> {t('common.browse')}
