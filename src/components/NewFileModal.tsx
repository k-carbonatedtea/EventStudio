...
// 新建 .bfevfl 事件流文件弹窗组件
export default function NewFileModal({ isOpen, targetDir, onClose, onConfirm }: NewFileModalProps) {
  ...
  const displayDir = targetDir.startsWith('SARC:') ? targetDir.replace('SARC:', '') : targetDir;
            ...
            <div className="settings-field" style={{ marginTop: '12px' }}>
              <label>
                ...
                <span className="field-desc">
                  {locale === 'zh'
                    ? '支持输入名称如 Demo001_0 或 Demo001_0.bfevfl'
                    : 'e.g. Demo001_0 or Demo001_0.bfevfl'}
                </span>
              </label>
