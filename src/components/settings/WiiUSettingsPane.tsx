    ...
    <div className="settings-tab-pane">
      ...
      <div className="settings-field">
        ...
        <div className="path-input-group">
          ...
          <button
            ...
            onClick={() => onBrowse("gameDir", locale === 'zh' ? "选择 Wii U 本体 content 目录" : "Select Wii U Base content Directory")}
          >
      ...
      <div className="settings-field">
        <label>
          ...
          <span className="field-desc">
            {locale === 'zh' ? 'v1.5.0 / v1.6.0 更新补丁 MLC content 文件夹 (推荐配置)' : 'v1.5.0 / v1.6.0 Update MLC content directory (Recommended)'}
          </span>
        </label>
        <div className="path-input-group">
          <input
          ...
          <button
            type="button"
            className="browse-btn"
            onClick={() => onBrowse("updateDir", locale === 'zh' ? "选择 Wii U 补丁 content 目录" : "Select Wii U Update content Directory")}
          >
            <Folder size={14} /> {t('common.browse')}
          </button>
        </div>
      ...
      <div className="settings-field">
        <label>
          ...
          <span className="field-desc">
            {locale === 'zh' ? 'DLC 扩展包 MLC content/0010 文件夹' : 'DLC expansion MLC content/0010 directory'}
          </span>
        </label>
        <div className="path-input-group">
          <input
          ...
          <button
            type="button"
            className="browse-btn"
            onClick={() => onBrowse("dlcDir", locale === 'zh' ? "选择 Wii U DLC content 目录" : "Select Wii U DLC content Directory")}
          >
            <Folder size={14} /> {t('common.browse')}
          </button>
        </div>
      ...
      <div className="settings-field">
        <label>
          ...
          <span className="field-desc">
            {locale === 'zh' ? '用于导出和加载生成的模组补丁包' : 'Target directory for exporting generated mod pack'}
          </span>
        </label>
        <div className="path-input-group">
          <input
          ...
          <button
            type="button"
            className="browse-btn"
            onClick={() => onBrowse("exportDir", locale === 'zh' ? "选择模组导出路径" : "Select Mod Export Directory")}
          >
            <Folder size={14} /> {t('common.browse')}
          </button>
        </div>
