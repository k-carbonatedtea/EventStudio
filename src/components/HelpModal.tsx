    ...
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="settings-tabs" style={{ padding: '0 16px' }}>
          ...
          <button
            className={`settings-tab-btn ${activeTab === 'nodes' ? 'active' : ''}`}
          ...
          <button
            className={`settings-tab-btn ${activeTab === 'faq' ? 'active' : ''}`}
          ...
          {activeTab === 'guide' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              >
                ...
                >
                  <li>
                    <strong>{locale === 'zh' ? '独立文件与封包' : 'Single File & Package'}</strong>:{' '}
                    {locale === 'zh'
                      ? '点击顶部 文件(F) -> 打开(O)... 或按 Ctrl+O 选择 .bfevfl、.sbeventpack、.msbt、.aamp 等文件。'
                      : 'Click File -> Open File... or press Ctrl+O to select .bfevfl, .sbeventpack, .msbt, .aamp files.'}
                  </li>
                  <li>
                    <strong>{locale === 'zh' ? '模组工程目录' : 'Mod Project Folder'}</strong>:{' '}
                    {locale === 'zh'
                      ? '点击 文件(F) -> 打开模组文件夹... 打开包含 romfs 结构的 Atmosphere / Cemu 模组目录，左侧自动生成多层级资源树。'
                      : 'Click File -> Open Mod Folder... to load Atmosphere/Cemu mod directory with full file explorer.'}
                  </li>
                  <li>
                    <strong>{locale === 'zh' ? '拖拽即开' : 'Drag & Drop'}</strong>:{' '}
                    {t('empty.dragHint')}
                  </li>
                </ul>
              </div>
              ...
              >
                ...
                >
                  <li>
                    <strong>BFEVFL</strong>:{' '}
                    {locale === 'zh'
                      ? '支持可视化流程图与 Monaco JSON 源码实时互转编辑（按 J 键切换，Ctrl+S 保存自动写回二进制）。'
                      : 'Supports visual flowchart & raw Monaco JSON two-way editing (press J to toggle, Ctrl+S writes binary).'}
                  </li>
                  <li>
                    <strong>MSBT</strong>:{' '}
                    {locale === 'zh'
                      ? '原生游戏文本本地化编辑器，支持颜色控制标签 <1:colour> 装饰与即时渲染。'
                      : 'Native localization text editor with <1:colour> tag decorations & live render.'}
                  </li>
                  <li>
                    <strong>AAMP / BYML</strong>:{' '}
                    {locale === 'zh'
                      ? '自动反编译为 YAML 源码进行 Monaco 编辑并编译写回。'
                      : 'Auto decompiles to YAML source and compiles back to binary upon saving.'}
                  </li>
                </ul>
              </div>
              ...
              >
                <h4 style={{ margin: '0 0 8px 0', color: '#f8fafc' }}>
                  {locale === 'zh'
                    ? '3. 历史时间轴与多步快照恢复'
                    : '3. History Timeline & Autosave Recovery'}
                </h4>
              ...
              >
                <h4 style={{ margin: '0 0 8px 0', color: '#f8fafc' }}>
                  {locale === 'zh'
                    ? '4. 语言包与台词文本预览'
                    : '4. Language Packs & Dialogue Preview'}
                </h4>
                <div style={{ fontSize: '0.85rem', color: '#cbd5e1', lineHeight: 1.6 }}>
                  {locale === 'zh'
              ...
              >
                ...
                <div style={{ fontSize: '0.85rem', color: '#94a3b8', lineHeight: 1.6 }}>
                  ...
                  >
                    ...
                    <div>
                      • <strong>Discord:</strong> <code style={{ color: '#60a5fa' }}>ylimhs_</code>{' '}
                      {t('about.or')} <code style={{ color: '#60a5fa' }}>carbonatedtea</code>
                    </div>
                    <div>
                      • <strong>QQ:</strong> <code style={{ color: '#34d399' }}>2875285430</code>
                    </div>
                  </div>
                </div>
              </div>
